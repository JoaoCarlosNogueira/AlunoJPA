...
public class DAO<VO> {
 ...
 // Superclasse para as classes de persistencia (DAO)
 // Implementa as operações básicas da manipulação de entidades (incluir,alterar e excluir), além do controle de transações.